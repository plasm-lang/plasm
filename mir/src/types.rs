...
pub struct TypeArena {
    ...
    unnamed_types: BiHashMap<TypeId, MIRType>,
    next_type_id: TypeId,
}
...
impl TypeArena {
    ...
    pub fn insert_unnamed(&mut self, ty: MIRType) -> TypeId {
        let id = self.next_id();
    ...
    pub fn get_or_insert(&mut self, ty: MIRType) -> TypeId {
